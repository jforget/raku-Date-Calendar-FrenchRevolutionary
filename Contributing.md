...
[https://github.com/jforget/raku-Date-Calendar-FrenchRevolutionary]
and create an issue.
...
also known as "designer's notes", to better grasp the
...
directory as `Date::Calendar::FrenchRevolutionary`:
...
For this, from the `raku-Date-Calendar-FrenchRevolutionary` directory, run:
