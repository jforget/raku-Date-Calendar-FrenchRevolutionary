...
The first difference with Perl 5's F<DateTime> is that Perl 6's F<Date>
uses the MJD or Modified Julian Day Number instead of I<Rata Die>.
Fine with me.

=head3 Immutability

A second difference with Perl 5's F<DateTime>
...
F<Date::Calendar::Whatever>  objects will  have a  C<locale> attribute
...
So the  object is not  fully immutable. Changing "Sextidi  26 Messidor
227, jour de la  sauge" into "Sixday 26 Reapidor 227,  day of sage" is
just  a skin-deep  cosmetic modification,  while changing  "Sextidi 26
Messidor 227, jour de la sauge" into "Septidi 27 Messidor 227, jour de
l'ail" is a deep modification of the date's inner self.
